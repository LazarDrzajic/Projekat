...
public class HumanityEditStaff {
	...
	private static final String UPLOADPICTURE_XPATH = "C:\\\\Users\\\\Test\\\\Downloads\\\\maxresdefault.jpg";
	...
	//Upload picture
	public static void SetImage(WebDriver driver) throws Exception {
		getAddPictureBtn(driver).sendKeys(UPLOADPICTURE_XPATH);
		Thread.sleep(3000);
	}
